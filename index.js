...
async function run() {
    try {
        ...
        app.get('/jobs', async (req, res) => {
            ...
            if (search) {
                const searchResult = jobs.filter(job => job.type.toLocaleLowerCase().includes(search));
        ...
        app.get('/sellerProfile', async (req, res) => {
            ...
            if (search) {
                const searchResult = sellers.filter(seller => seller.speciality.toLocaleLowerCase().includes(search));
                res.send(searchResult);
            } else {
        ...
        app.put('/sellerProfile/:id', async (req, res) => {
            ...
            const result = await sellerProfileCollection.updateOne(filter, updateDoc, options);
